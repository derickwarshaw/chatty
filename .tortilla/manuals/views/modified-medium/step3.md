...
-┊ 6┊  ┊} from 'react-native';
 ┊ 7┊ 2┊
 ┊ 8┊ 3┊import { ApolloClient } from 'apollo-client';
 ┊ 9┊ 4┊import { ApolloLink } from 'apollo-link';
 ┊10┊ 5┊import { ApolloProvider } from 'react-apollo';
 ┊11┊ 6┊import { composeWithDevTools } from 'redux-devtools-extension';
 ┊12┊ 7┊import { createHttpLink } from 'apollo-link-http';
-┊13┊  ┊import { createStore, combineReducers } from 'redux';
+┊  ┊ 8┊import { createStore, combineReducers, applyMiddleware } from 'redux';
 ┊14┊ 9┊import { Provider } from 'react-redux';
 ┊15┊10┊import { ReduxCache, apolloReducer } from 'apollo-cache-redux';
 ┊16┊11┊import ReduxLink from 'apollo-link-redux';
 ┊17┊12┊
...
+┊  ┊16┊} from './navigation';
+┊  ┊17┊
 ┊18┊18┊const URL = 'localhost:8080'; // set your comp's url here
 ┊19┊19┊
 ┊20┊20┊const store = createStore(
 ┊21┊21┊  combineReducers({
 ┊22┊22┊    apollo: apolloReducer,
...
+┊  ┊28┊  ),
 ┊26┊29┊);
 ┊27┊30┊
 ┊28┊31┊const cache = new ReduxCache({ store });
```
```diff
@@ -41,42 +44,12 @@
 ┊41┊44┊  cache,
...
-┊61┊  ┊});
-┊62┊  ┊
 ┊63┊47┊export default class App extends Component {
 ┊64┊48┊  render() {
 ┊65┊49┊    return (
 ┊66┊50┊      <ApolloProvider client={client}>
 ┊67┊51┊        <Provider store={store}>
...
```diff
@@ -3763,6 +3763,12 @@
 ┊3763┊3763┊    xmldoc "^0.4.0"
 ┊3764┊3764┊    yargs "^9.0.0"
 ┊3765┊3765┊
+┊    ┊3766┊react-navigation-redux-helpers@^1.0.1:
+┊    ┊3767┊  version "1.0.1"
+┊    ┊3768┊  resolved "https://registry.yarnpkg.com/react-navigation-redux-helpers/-/react-navigation-redux-helpers-1.0.1.tgz#1d98cb6364ebdf98a90d34aa7b4592b9073d76e2"
+┊    ┊3769┊  dependencies:
+┊    ┊3770┊    invariant "^2.2.2"
+┊    ┊3771┊
 ┊3766┊3772┊react-navigation@^1.0.3:
 ┊3767┊3773┊  version "1.0.3"
 ┊3768┊3774┊  resolved "https://registry.yarnpkg.com/react-navigation/-/react-navigation-1.0.3.tgz#1687ea67a72a382633b01e7afda88582ebc3b5f9"
```
